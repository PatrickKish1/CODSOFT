...
class UsersPage(QWidget):
    ...
    def initUI(self):
        ...
        self.email_input.setFixedSize(QSize(250, 35))  # Fixed size for email input
        self.email_input.setPlaceholderText("Email")
        self.password_input = QLineEdit()
        self.password_input.setFixedSize(QSize(250, 35))  # Fixed size for password input
        ...
        self.login_button.setFixedSize(QSize(140, 35))  # Fixed size for login button
        self.login_button.clicked.connect(self.login_user)
        self.signup_button = QPushButton("Sign Up")
        self.signup_button.setFixedSize(QSize(140, 35))  # Fixed size for signup button
    ...
    def login_user(self):
        ...
        if self.validate_user(email, password):
            ...
            self.parent.show_activities_page()
        else:
